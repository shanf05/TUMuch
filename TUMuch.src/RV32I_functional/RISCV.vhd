...
architecture functional of RISCV is
    file TraceFile : Text open write_mode is "../../../../TUMuch.rsc/RV32I_functional/test_traces/trace.txt";    --SPECIFY YOUR DESIRED OUTPUT TRACE FILE
    file AsmFile : Text open read_mode is "../../../../TUMuch.rsc/RV32I_functional/tests/asm_input.txt";         --SPECIFY YOUR DESIRED INPUT TEST FILE
    file DataDumpFile : Text open write_mode is "../../../../TUMuch.rsc/RV32I_functional/data_dump.txt";         --SPECIFY YOUR DESIRED OUTPUT MEMORY DUMP FILE
    file BinFile : Text open read_mode is "../../../../TUMuch.rsc/RV32I_functional/bin_input.txt";               --SPECIFY YOUR DESIRED INPUT TEST FILE
